    ...
    for dataset in dataset_list:
        if dataset == 'UCR':
            ...
            for idx in index_range:
                ...
                cmd = ['python', 'semisupervised.py', '--model_name', model_name, '--dataset_name', dataset, '--index', str(idx),
                       '--task_name', 'semisupervised', '--train_test_split', str(train_test_split), '--win_size', str(win_size),
            ...
            cmd = ['python', 'semisupervised.py', '--model_name', model_name, '--dataset_name', dataset,
