...
class RF(BaseDetector):
    """Random Forest classifier for supervised time series anomaly detection.
    """
    ...
    def fit(self, X, y):
        ...
        if hasattr(self.clf_, 'predict_proba'):
            ...
            # Fallback to decision path length count if no proba; here normalize predictions
