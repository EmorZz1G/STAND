...
logs_file_pth2 = logs_pth / 'supervised_robust_exp_all_test.csv'
# logs_file_pth3 = logs_pth / 'supervised_robust_exp_left_test.csv'
import os
import sys
...
if noise_prob > 0:
    ...
    noise_indices = np.random.choice(train_n, size=int(train_n * noise_prob), replace=False)
