...
def get_parse_args() -> ArgumentParser:
    ...
    parser.add_argument('--model_saving_path', type=str, default='/home/pcl/zzj/projects/STAND/model_saving', help='Path to save the trained model')
    ...
    parser.add_argument('--dataset_path', type=str, default='/home/pcl/zzj/projects/FTSAD/datasets', help='Path to the dataset')
    ...
    parser.add_argument('--noise_prob', type=float, default=0.0, help='Probability of adding noise to the data')
